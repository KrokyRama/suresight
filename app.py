...
@app.route('/premi', methods=['GET', 'POST'])
def form():
    premi = None  # Default result value
    if request.method == 'POST':
        jumlah_tahun_str = request.form.get('jumlah_tahun')
